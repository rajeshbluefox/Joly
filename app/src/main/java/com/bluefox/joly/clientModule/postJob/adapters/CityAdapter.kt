...
class CityAdapter(context: Context, resource: Int, private val items: List<City>) :
    ArrayAdapter<City>(context, resource, items) {
    ...
    private fun createView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        textView.text = items[position].CityName
